...
class Car:
    ...
    def __init__(self, consumption_per_100km: float):
        if not isinstance(consumption_per_100km, (int, float)) or isinstance(consumption_per_100km, bool):
    ...
    def fill_up(self, liters: float):
        if not isinstance(liters, (int, float)) or isinstance(liters, bool):
...
class Track:
    ...
    def __init__(self, trailer_consumption_per_100km: float, trailer_count: int):
        if not isinstance(trailer_consumption_per_100km, (int, float)) or isinstance(trailer_consumption_per_100km, bool):
            raise TypeError("Trailer consumption must be a number.")
        if not isinstance(trailer_count, int) or isinstance(trailer_count, bool):
    ...
    def set_trailer_count(self, new_count: int):
        if not isinstance(new_count, int) or isinstance(new_count, bool):
            raise TypeError("Trailer count must be an integer.")
